...
def main(resources_dir):
    input_dir = f'{resources_dir}/linux/log'  # The input directory of log file
    output_dir = f'{resources_dir}/linux/log-templates'  # The output directory of parsing results
