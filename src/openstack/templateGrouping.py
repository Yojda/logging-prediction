...
def main(resources_dir):
    ...
    df = pd.read_csv(f"{resources_dir}/openstack/log-templates/OpenStack.log_structured.csv")
    ...
    df.to_csv(f"{resources_dir}/openstack/log-templates/OpenStack.log_structured.csv", index=False)